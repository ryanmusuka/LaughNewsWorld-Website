  ...
  return (
    <main className="min-h-screen bg-[#F9F9F8] dark:bg-zinc-950 text-black dark:text-white pt-28 pb-16 px-6 flex flex-col items-center">
      ...
      <article className="max-w-2xl w-full mx-auto space-y-16 md:space-y-20">
        ...
        {/* 1. THE HOOK (Triggers on load, so it's fine as a group) */}
        <motion.section 
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-lg md:text-xl text-zinc-600 dark:text-zinc-400 font-medium leading-relaxed text-center">
        ...
        {/* 2. THE GENESIS (Changed wrapper to <section>, triggers are now on the elements) */}
        <section className="space-y-6">
          <motion.h2 
            initial="hidden" animate="visible" variants={fadeUp} 
            className="block w-fit mx-auto text-3xl md:text-4xl font-black uppercase tracking-tighter border-b-[8px] border-brand-yellow pb-2 text-center"
          >
            The Genesis
          </motion.h2>
          <motion.p 
            initial="hidden" animate="visible" variants={fadeUp} 
            className="text-lg text-zinc-800 dark:text-zinc-300 leading-relaxed"
          >
        ...
        <section className="space-y-6">
          ...
          <ul className="space-y-4 mt-6">
            <motion.li initial="hidden" animate="visible" variants={fadeUp} className="flex gap-4">
